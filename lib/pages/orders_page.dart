...
class _OrdersPageState extends State<OrdersPage> {
  ...
  Future<void> getAllMissions() async {
    try {
      final url = Uri.parse('${apiUrl('bOrders')}/${widget.userId}');
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    const Icon(Icons.shopping_bag, color: Colors.blueAccent,size: 15,),
                ...
                Row(
                  children: [
                    const Icon(Icons.scale, color: Colors.blueAccent,size: 15,),
                    const SizedBox(width: 8), // Reduced width
                    const Text(
                      'Weight:',
                      style: TextStyle(
                ...
                Row(
                  children: [
                    const Icon(Icons.currency_rupee, color: Colors.blueAccent,size: 15,),
                    const SizedBox(width: 8), // Reduced width
                    const Text(
                      'Cost Per Kg:',
                      style: TextStyle(
                ...
                Row(
                  children: [
                    const Icon(Icons.person, color: Colors.blueAccent,size: 15,),
                    const SizedBox(width: 8), // Reduced width
                    const Text(
                      'Customer:',
                      style: TextStyle(
                ...
                Row(
                  children: [
                    const Icon(Icons.calendar_today, color: Colors.blueAccent,size: 15,),
                    const SizedBox(width: 8), // Reduced width
                    const Text(
                      'Ordered Date:',
                      style: TextStyle(
                ...
                Row(
                  children: [
                    const Icon(Icons.delivery_dining, color: Colors.blueAccent,size: 15,),
                    const SizedBox(width: 8), // Reduced width
                    const Text(
                      'Delivery Date:',
                      style: TextStyle(
                ...
                Row(
                  children: [
                    const Icon(Icons.info_outline, color: Colors.blueAccent,size: 15,),
                    const SizedBox(width: 8), // Reduced width
                    const Text(
                      'Status:',
                      style: TextStyle(
